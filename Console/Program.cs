...
var startingHeight = 700000;
var blockCount = 89753;
var batchSize = 12;
...
try
{
    ...
    List<Task> tasks = new();
    int j = 0;
    for (var i = startingHeight; i < (startingHeight + blockCount); i++)
    {
        tasks.Add(logic.LoadBlock(i));
        j++;
        if(j == batchSize)
        {
...
finally
{
    ...
    Console.WriteLine($"blocks/second: {blockCount / stopwatch.Elapsed.TotalSeconds}");
    Console.ReadLine();
}
...
//    {
        ...
        //                async tx =>
        //                {
        //                    //TODO: MERGE Transaction? MERGE Output?
